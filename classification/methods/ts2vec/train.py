...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default="traffic", help='The dataset name')
    ...
    parser.add_argument('--loader', type=str, default="traffic", help='The data loader used to load the experimental data. This can be set to UCR, UEA, forecast_csv, forecast_csv_univar, anomaly, or anomaly_coldstart')
    ...
    parser.add_argument('--eval', action="store_false", help='Whether to perform evaluation after training')
    ...
    # parser.add_argument('--max-train-length', type=int, default=24, help='For sequence with a length greater than <max_train_length>, it would be cropped into some sequences, each of which has a length less than <max_train_length> (defaults to 3000)')
    ...
    if args.loader == 'traffic':
        task_type = 'classification'
        train_data, train_labels, test_data, test_labels = datautils.load_traffic()
